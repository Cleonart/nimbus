...
### Get started
- Make sure you have JDK 17 already installed
- Make sure kotlin was installed on your local machine
- Configure VS Code by install ext: Kotlin Formatter, Extension Pack For Java, Spring Boot Extension Pack

### To Start
- Make sure gradle was successfully buld
- Run by use `./gradlew bootRun --info`
