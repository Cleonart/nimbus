export default {
  currency: (prefix = "Rp. ", value = 0) => {
    ...
    const prefixData = rawValue < 0.0 ? "-" : "";
    return prefix == undefined
      ? rupiah
      : rupiah
      ? prefixData + "Rp" + rupiah
      : "";
  },
  ...
  roundingValue({ numberValue = 0.0, decimalPlaces = 2.0 }) {
    return parseFloat(parseFloat(numberValue).toFixed(decimalPlaces));
  },
};
